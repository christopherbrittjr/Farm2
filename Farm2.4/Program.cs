...
namespace Farm2._4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Horse ed = new Horse("My name is Ed.  ", "I talk like you humans even though I am a horse.  ","I like to eat hay  ", "I also allow people to ride on me.\n");
            Duck darkwing = new Duck("I am known as Darkwing Duck.  ", "This is my catch phrase.  I am the terror that flaps in the night, I am the scourge that pecks at your nightmares, I am DARKWING DUCK!  ",
                                     "As someone whom is on the go, I like myself a good burger.  ","I fight crime to keep this city safe!\n");
